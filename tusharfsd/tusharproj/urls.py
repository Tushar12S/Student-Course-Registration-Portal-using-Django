"""
URL configuration for tusharproj project.
...
from tusharapp.views  import  generateCSV, home,registerAjax,enrolledStudentsUsingAjax,studentlist,courselist,register,enrolledStudents,add_project,StudentListView,StudentDetailView,generatePDF
urlpatterns = [
